...
def generate_proposal():
    ...
    try:
        ...
        raw_context.update({
            'name':               str(context.get('name', 'N/A')),
            'location':           str(context.get('location', 'N/A')),
            'capacity':           safe_float(context.get('capacity'), safe_float(context.get('capacity_kw'))),
            'rate_per_watt':      safe_float(context.get('rate_per_watt'), safe_float(context.get('ratePerWatt'))),
            'base_amount':        safe_float(context.get('base_amount'), safe_float(context.get('baseAmount'))),
            'final_amount':       safe_float(context.get('final_amount'), safe_float(context.get('finalAmount'))),
            'cgst_amount':        safe_float(context.get('cgst_amount'), safe_float(context.get('cgstAmount'))),
            'sgst_amount':        safe_float(context.get('sgst_amount'), safe_float(context.get('sgstAmount'))),
            ...
            'unit_rate':          safe_float(context.get('unit_rate'), safe_float(context.get('unitRate'))),
            'grid_tariff_per_unit': safe_float(context.get('unit_rate'), safe_float(context.get('unitRate'))),
            'client_type':        str(context.get('client_type') or context.get('clientType') or 'Commercial'),
